"================= List =================="
# списки - это изменяемый, индексируемый, упорядоченный, итерируемый тип данных, предназначенный для хранения данных в определенном порядке
...
list_.append("hello")
print(list_) # [1, "hello"]
list_.append([1,2,3,4]) # здесь один элемент - 1 список
list_.append(1,2,3) # TypeError # можно только один эелемент
