"""
Создать список из чисел в диапазоне о  1 до 10
"""
# 1 
...
"""
НАйти смму всех чисел в списке
"""
# 1
list_sum = sum(list)
# 2
...
"""
Найти остаток от деления суммы на число в input
"""
# 1
remainder = list_sum % num
# 2
div, remainder = divmode(list_sum,num)
# (div - пустая переменная т.к нам нужен тольк остаток, а divmod дает и остаток и целое число)
...
# 4 
string = list(filter(lambda x: type(x) == str, list1))
uppper_string = [s.upper() for s in string]
